    ...
    <q-card class="full-height column col" :class="$q.platform.is.mobile ? '' : 'q-ma-md'">
      ...
      <q-card-section>
        <div class="row justify-center">
          <div class="col-auto">
            <div class="row items-center no-wrap q-pb-md text-primary"
              :class="$q.platform.is.mobile ? 'text-h4' : 'text-h3'">
              <q-icon name="lock" :size="$q.platform.is.mobile ? 'md' : 'xl'" class="q-mr-sm" />
              <span>Encrypt</span>
            </div>
          </div>
        </div>
        <div class="row q-pb-md">
          <div class="col-lg-12 col-xs-grow">
            <q-btn-toggle v-model="option" spread no-caps text-color="black" :options="[
        ...
        <div class="row" v-if="option === 1">
          <div class="col-lg-12 col-xs-grow">
            ...
            <q-input class="limited-textarea-smaller" v-model="dataToEncrypt" filled type="textarea" />
          </div>
        </div>
        <div class="row items-center q-pt-md">
          <div class="col-12">
            ...
            <q-checkbox :model-value="true" label="AES-256 CBC algorithm" disable>
              <q-tooltip>
                AES CBC algorithm based on 256 bit long key is
                considered as secure encryption algorithm.
              </q-tooltip>
            </q-checkbox><br>
            <q-checkbox :model-value="true" label="Random IV vector generation" disable>
              <q-tooltip>
                16 bytes long IV vector is required part of AES CBC encryption.
                The value will be randomly generated.
              </q-tooltip>
            </q-checkbox><br>
            <q-checkbox :model-value="true" label="PKCS7 payload padding" disable>
              <q-tooltip>
        ...
        <div class="row q-pt-md">
          <div class="col-12">
            ...
            <q-input bottom-slots v-model="encryptionKey" :type="isPwd ? 'password' : 'text'" label="Encryption key"
            ...
            <q-input bottom-slots v-model="encryptionKey2" :type="isPwd ? 'password' : 'text'"
        ...
        <div class="row justify-center text-center items-center q-pt-md">
          <div class="col-grow">
            <q-btn color="primary" icon="lock" label="Encrypt" @click="encrypt" :disable="encryptionKey === null ||
              encryptionKey2 === null ||
...
export default {
  ...
  data() {
    return {
      ...
      cbc: true,
      useSha256: true,
      maxlength: 'No restrictions, no limit.',
      encryptionKey: null,
      encryptionKey2: null,
      dataToEncrypt: null,
      encryptedFileContent: null,
      passwordHint: 'encryption key will be SHA-256 checksum of your password',
      isPwd: true,
      isPwd2: true,
